#!/usr/bin/env python3
r"""
Engine vs Engine - Pure UCI + Draw Detection + Batch Mode (Atomic only)
...
GAMES_PER_MATCHUP = 1     # games per color combination
...
def main():
    ...
    print("=" * 70)
    print("  ENGINE vs ENGINE - Atomic Only")
    ...
    # Matchup 1: Atomic - Original vs Swapped
